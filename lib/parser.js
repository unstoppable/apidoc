...
Parser.prototype.parseContent = function(src, parsedFiles, parsedFilenames) {
    var self = this;
    ...
    var parsedFile = self._parseBlockElements(self.indexApiBlocks, self.elements, filename);
